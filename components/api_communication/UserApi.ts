...
export const userApi = {
  ...
  async addUserSavedDiet(params: UserSavedDietParams) {
    try {
      return await connection.api
        .post<UserSavedDietParams, AxiosResponse<UserSavedDiet>>(
          `user/userSavedDiet/add`,
          params
        )
        .then((response) => response.data);
    } catch (e) {
  ...
  async addUserSavedTraining(params: UserSavedTrainingParams) {
    try {
      return await connection.api
        .post<UserSavedTrainingParams, AxiosResponse<UserSavedTraining>>(
          `user/userSavedTraining/add`,
          params
        )
        .then((response) => response.data);
    } catch (e) {
  ...
  async deleteUserSavedTraining(id: EntityId) {
    try {
      return await connection.api
        .post<EntityId, AxiosResponse<UserSavedTraining>>(
          `user/userSavedTraining/delete/${id}`
        )
        .then((response) => response.data);
    } catch (e) {
      console.log("error w userApi " + e);
  ...
  async deleteUserSavedDiet(id: EntityId) {
    try {
      return await connection.api
        .post<EntityId, AxiosResponse<UserSavedDiet>>(
          `user/userSavedDiet/delete/${id}`
        )
        .then((response) => response.data);
    } catch (e) {
      console.log("error w userApi " + e);
